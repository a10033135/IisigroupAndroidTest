...
@Composable
fun FlightShimmerContent(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier,
...
private fun FlightShimmerItem() {
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Row(
            ...
            Box(modifier = Modifier.size(40.dp).background(brush, MaterialTheme.shapes.small))
            ...
            Column(
                ...
                Box(modifier = Modifier.fillMaxWidth(0.5f).height(10.dp).background(brush))
            }
            Box(
                modifier = Modifier
                    .width(40.dp)
